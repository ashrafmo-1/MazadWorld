            ...
            <div className='flex   items-center justify-center  pt-4 pb-28 sm:my-[20px]'>
                <div className='w-[424px]  max-sm:w-[300px] shadow-2xl pb-10 mt-10  text-xl font-semibold '>
                    ...
                    <div className='flex flex-col text-sm text-[#5F6C72] pl-7 max-sm:pl-3 pt-4 gap-2'>
                        <div> Already have account? <button className='text-[#2DA5F3]'><Link to='/login'>Sign In</Link>
                        </button></div>
                        <div> Don’t have account? <button className='text-[#2DA5F3]'><Link to='/signup'>Sign Up</Link>
                        </button></div>
                    </div>
                    ...
                    <div className='text-sm text-[#A3A7AA] px-7 max-sm:pl-3   pt-4'>
                        You may contact<span className=' text-orange-500'> Customer Service</span> for help restoring
