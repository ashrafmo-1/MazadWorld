        ...
        <div className='flex   items-center justify-center  pt-4 pb-28 sm:my-[20px]'>
            <div className='w-[424px]  max-sm:w-[300px] shadow-2xl pb-10 mt-10   '>
                <div className='text-xl font-semibold'>
                    <button className='w-[212px] max-sm:w-[150px] h-[60px] text-[#77878F]'><Link to='/login'>
                        Sign In
                    </Link></button>
                ...
                <div className='pl-9  max-sm:pl-3   pt-3 flex gap-3 items-center'>
                    ...
                    <div> Are you agree to Clicon <span className='text-blue-700'>Terms of Condition</span> and <span
                        className='text-blue-700'>Privacy Policy </span>.
                    </div>
                </div>
