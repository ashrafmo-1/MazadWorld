            ...
            <div className='w-[424px] h-[400px] max-sm:w-[300px] shadow-2xl pb-10 mt-10  text-xl font-semibold '>
                <div
                    ...
                    <p className='text-[#5F6C72] font-normal text-sm pt-1'>
                        Duis sagittis molestie tellus, at eleifend sapien pellque quis. Fusce lorem nunc, fringilla
                        sit amet nunc. </p>
                </div>
                <div className='  flex flex-col  pl-9  max-sm:pl-3 '>
                    <div
                        className='flex  items-start justify-start text-start text-sm font-normal max-sm:gap-20 py-4   '>
                        <h1>Password</h1>
                    </div>
                ...
                <div className='  flex flex-col  pl-9  max-sm:pl-3   '>
                    <div
                        className='flex  items-start justify-start text-start max-sm:gap-20 py-4 text-sm font-normal  '>
                ...
                <div className='bg-white h-[48px] mt-8  mx-auto w-[360px]  max-sm:w-[280px]  '>
                    <button
                        className='bg-[#FA8232] h-[48px] w-[360px]  max-sm:w-[280px] flex justify-center items-center gap-1 text-sm font-semibold text-white text-center  uppercase  rounded'> Reset
                        Password<img
                            src={Aro}/></button>
