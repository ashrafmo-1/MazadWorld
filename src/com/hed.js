                    ...
                    <div
                        ...
                        <div className='flex gap-4'>
                            ...
                            <ol className='flex gap-2 max-sm:justify-center items-center'>
                                <li><a href='https://x.com/' target='_blank'><img src='/src/img/Twitter.svg'/></a></li>
                                <li><a href='https://www.facebook.com/' target='_blank'><img src='/src/img/Facebook.png'/></a></li>
                                <li><a href='https://www.youtube.com/' target='_blank'><img src='/src/img/Youtube.svg'/></a></li>
                                <li><a href='https://www.instagram.com/' target='_blank'><img src='/src/img/Instagram.svg'/></a></li>
                            </ol>
                        </div>
                        <div>
                            Eng
                        ...
                        <div className='flex   items-center gap-2  '>
                            ...
                            <div className='flex gap-2  '>
                                ...
                                <button className=' flex  h-[24px] text-sm w-[89px] items-center justify-center gap-1'>
                                    <img
                                        className='flex w-[24px] h-[24px]' src='/src/img/ArrowsCounterClockwise.svg'/> Compare
                                </button>
                                <button
